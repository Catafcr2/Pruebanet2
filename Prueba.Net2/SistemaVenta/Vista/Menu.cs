...
namespace SistemaVenta.Vista
{
    ...
    {
        private float preciodePizza, preciodeBebida, precioTotal;
        private string tipodePizza, tipodeBebida, tamanoPizza, tamanoBebida;
        ...
        private void caerrarCajaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Total Recaudado es:" + registros.SumaTotal());
        ...
        private void btnAgregarPedido_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Completar Campos faltantes Porfavor");
            }
        ...
        private int ContadordeRegistros()
        {
            using (SistemaVenta.Modelo.ConnectDB bd = new SistemaVenta.Modelo.ConnectDB())
            {
        ...
        {
            if(txtCantidaddeBebida.TextLength != 0)
            {
                tipoBebida = cmbTipodeBebida.SelectedItem.ToString();
            }
            else
            {
                tipoBebida = "N/A";
        ...
        private float PrecioTotal()
        {
            ...
            else if (txtCantidaddePizza.TextLength == 0 && txtCantidaddeBebida.TextLength != 0)
            {
                precioTotal = PrecioBebida();
            }
            else if (txtCantidadPizza.TextLength != 0 && txtCantidaddeBebida.TextLength != 0)
            {
